...
AOSPBRANCH="refs/tags/android-13.0.0_r20"
...
git checkout $LOSBRANCH
git am --signoff < "$PATCHESDIR/frameworks_av/0001-Revert-Camera-Avoid-roundBufferDimensionsNearest-als.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0002-Revert-Camera-Skip-stream-size-check-for-whitelisted.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0003-Revert-Camera-Reduce-latency-for-dejittering.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0004-Revert-Camera-Avoid-dequeue-too-many-buffers-from-bu.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0005-Revert-Camera-Avoid-latency-accumulation-when-syncin.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0006-Revert-Add-disable-enable-camera-service-watchdog-fe.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0007-1-2-libcameraservice-reset-to-a0a10c95a363a0df93da67.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0008-2-2-libcameraservice-massive-revert-to-Android-12-st.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0009-camera-Allow-to-use-boottime-as-timestamp-reference.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0010-libaudiohal-Bring-back-2.0-HAL.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0011-camera-Allow-devices-to-load-custom-CameraParameter-.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0012-Revert-Camera-Remove-old-recording-path-support.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0013-Camera-Restore-camera-HALv1-support-1-2.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0014-Camera-Add-extensions-to-CameraClient.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0015-nuplayer-Avoid-crash-when-codec-fails-to-load.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0016-camera-Don-t-segfault-if-we-get-a-NULL-parameter.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0017-libstagefright-Support-YVU420SemiPlanar-camera-forma.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0018-stagefright-omx-Don-t-signal-dataspace-change-on-leg.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0019-stagefright-ACodec-Resolve-empty-vendor-parameters-u.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0020-libstagefright-Free-buffers-on-observer-died.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0021-libstagefright-use-64-bit-usage-for-native_window_se.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0022-camera-include-Don-t-override-possible-overlayed-hea.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0023-Camera-check-metadata-type-before-releasing-frame.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0024-stagefright-add-changes-related-to-high-framerates-i.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0025-Camera-Add-support-for-preview-frame-fd.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0026-CameraSource.cpp-support-PIXEL_FORMAT_YUV420SP_NV21.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0027-libstagefright-Fix-memory-leak-due-to-lock-timeout.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0028-camera-media-Support-legacy-HALv1-camera-in-mediaser.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0029-APM-Restore-S-R-and-Q-behavior-respectively-for-tele.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0030-Fix-BT-in-call-on-CAF-devices.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0031-APM-Optionally-force-load-audio-policy-for-system-si.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0032-APM-Remove-A2DP-audio-ports-from-the-primary-HAL.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0033-audiopolicy-try-again-with-trimmed-audio-port-name-i.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0034-There-are-three-SCO-devices.-Fallback-from-one-to-th.patch"
...
git am --signoff < "$PATCHESDIR/frameworks_base/0009-hwui-reset-to-android-13.0.0_r13.patch"
git am --signoff < "$PATCHESDIR/frameworks_base/0010-Revert-Camera-Add-support-for-readout-timestamp.patch"
git am --signoff < "$PATCHESDIR/frameworks_base/0011-Add-support-for-app-signature-spoofing.patch" 
