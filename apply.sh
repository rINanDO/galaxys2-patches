...
git am --signoff < "$PATCHESDIR/frameworks_av/0009-Revert-DO-NOT-MERGE-libcameraservice-Provide-flag-fo.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0010-Revert-Fix-an-issue-that-the-syncTimestampToDisplayL.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0011-Revert-Camera-Avoid-latency-accumulation-when-syncin.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0012-Revert-Add-disable-enable-camera-service-watchdog-fe.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0013-libcameraservice-reset-to-a0a10c95a363a0df93da678b1e.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0014-libcameraservice-massive-revert-to-Android-12-state.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0015-camera-Allow-to-use-boottime-as-timestamp-reference.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0016-libaudiohal-Bring-back-2.0-HAL.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0017-camera-Allow-devices-to-load-custom-CameraParameter-.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0018-Revert-Camera-Remove-old-recording-path-support.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0019-Camera-Restore-camera-HALv1-support-1-2.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0020-Camera-Add-extensions-to-CameraClient.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0021-nuplayer-Avoid-crash-when-codec-fails-to-load.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0022-camera-Don-t-segfault-if-we-get-a-NULL-parameter.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0023-libstagefright-Support-YVU420SemiPlanar-camera-forma.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0024-stagefright-omx-Don-t-signal-dataspace-change-on-leg.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0025-stagefright-ACodec-Resolve-empty-vendor-parameters-u.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0026-libstagefright-Free-buffers-on-observer-died.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0027-libstagefright-use-64-bit-usage-for-native_window_se.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0028-camera-include-Don-t-override-possible-overlayed-hea.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0029-Camera-check-metadata-type-before-releasing-frame.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0030-stagefright-add-changes-related-to-high-framerates-i.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0031-Camera-Add-support-for-preview-frame-fd.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0032-CameraSource.cpp-support-PIXEL_FORMAT_YUV420SP_NV21.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0033-libstagefright-Fix-memory-leak-due-to-lock-timeout.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0034-camera-media-Support-legacy-HALv1-camera-in-mediaser.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0035-Fix-BT-in-call-on-CAF-devices.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0036-APM-Optionally-force-load-audio-policy-for-system-si.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0037-APM-Remove-A2DP-audio-ports-from-the-primary-HAL.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0038-audiopolicy-try-again-with-trimmed-audio-port-name-i.patch"
git am --signoff < "$PATCHESDIR/frameworks_av/0039-There-are-three-SCO-devices.-Fallback-from-one-to-th.patch"
...
git checkout $LOSBRANCH
git am --signoff < "$PATCHESDIR/frameworks_base/0001-Revert-DO-NOT-MERGE-CameraManager-Enable-override-to.patch"
git am --signoff < "$PATCHESDIR/frameworks_base/0002-Revert-DO-NOT-MERGE-CameraManager-Provide-flag-for-o.patch"
git am --signoff < "$PATCHESDIR/frameworks_base/0003-Revert-camera-Skip-HFR-checks-for-privileged-apps.patch"
git am --signoff < "$PATCHESDIR/frameworks_base/0004-Revert-Camera-Skip-stream-size-check-for-whitelisted.patch"
...
git am --signoff < "$PATCHESDIR/frameworks_base/0010-BiometricScheduler-Cancel-operation-if-not-idle.patch"
git am --signoff < "$PATCHESDIR/frameworks_base/0011-Hack-Ignore-SensorPrivacyService-Security-Exception.patch"
git am --signoff < "$PATCHESDIR/frameworks_base/0012-Disable-vendor-mismatch-warning.patch"
git am --signoff < "$PATCHESDIR/frameworks_base/0013-core-Remove-old-app-target-SDK-dialog.patch"
git am --signoff < "$PATCHESDIR/frameworks_base/0014-Fix-brightness-slider-curve-for-some-devices.patch"
git am --signoff < "$PATCHESDIR/frameworks_base/0015-sensors-Create-bool-to-select-what-timestamp-to-use.patch"
git am --signoff < "$PATCHESDIR/frameworks_base/0016-hwui-reset-to-android-13.0.0_r13.patch"
git am --signoff < "$PATCHESDIR/frameworks_base/0017-ColorFade-fix-EGL-crash-on-exynos4-mali-blobs.patch"
git am --signoff < "$PATCHESDIR/frameworks_base/0018-DisplayPowerController-Make-colorfade-configurable-v.patch"
git am --signoff < "$PATCHESDIR/frameworks_base/0019-StorageManagerService-Storage.xml-Bring-back-XML-for.patch"
git am --signoff < "$PATCHESDIR/frameworks_base/0020-frameworks-base-Enable-Aggressive-trim-settings.patch"
git am --signoff < "$PATCHESDIR/frameworks_base/0021-Add-support-for-app-signature-spoofing.patch" 
